...
{
    public class FoodProductProvider(IUnitOfWork unitOfWork, IMapper mapper, ILogger logger, IConfiguration configuration) : ProductProviderBase(unitOfWork, mapper, logger, configuration), IProductProvider
    {
